...
public class ListDBAdapter {
     ...
     */
    public long createList(String title, String body) {
        ContentValues initialValues = new ContentValues();
        initialValues.put(KEY_LISTNAME, title);
    ...
    public Cursor fetchAllLists() {
        ...
        return mDb.query(DATABASE_TABLE, new String[] {KEY_ROWID, KEY_LISTNAME,
    ...
    public Cursor fetchList(long rowId) throws SQLException {
        ...
        Cursor mCursor =
                ...
                mDb.query(true, DATABASE_TABLE, new String[] {KEY_ROWID,
                		KEY_LISTNAME, KEY_BODY}, KEY_ROWID + "=" + rowId, null,
                        null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
     ...
     */
    public boolean updateList(long rowId, String title, String body) {
        ContentValues args = new ContentValues();
        args.put(KEY_LISTNAME, title);
